...
class EventDetailTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(cellType: AddressTableViewCell.self)
        ...
        let view = EventDetailHeaderView(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height / 3))
        view.setupHeader(event: event)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            return cell
        case 1:
            let cell = tableView.dequeueReusableCell(for: indexPath) as AddressTableViewCell
