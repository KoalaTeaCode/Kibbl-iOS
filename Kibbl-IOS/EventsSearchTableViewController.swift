...
extension EventsSearchTableViewController {
    // MARK: Data/Paging
    ...
    func loadData(lastItemDate: String) {
        API.sharedInstance.getEventsWith(searchTerm: searchText.lowercased(), createdAtBefore: lastItemDate) { (returnedArray) in
...
extension EventsSearchTableViewController: UISearchBarDelegate {
...
extension EventsSearchTableViewController: UISearchResultsUpdating {
