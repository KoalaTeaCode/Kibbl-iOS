//
//  SheltersSearchTableViewController.swift
//  Kibbl-IOS
//
...
class SheltersSearchTableViewController: UITableViewController {
    
    typealias model = ShelterModel
    typealias cellType = ShelterTableViewCell
...
extension SheltersSearchTableViewController {
    // MARK: Data/Paging
    ...
    func loadData(lastItemDate: String) {
        API.sharedInstance.getSheltersWith(searchTerm: searchText.lowercased(), createdAtBefore: lastItemDate) { (returnedArray) in
...
extension SheltersSearchTableViewController: UISearchBarDelegate {
...
extension SheltersSearchTableViewController: UISearchResultsUpdating {
